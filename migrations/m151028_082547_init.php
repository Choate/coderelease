...
class m151028_082547_init extends Migration
{
    public function safeUp() {
        ...
        $this->createTable('{{%tasks}}', [
                ...
                'applicant'   => Schema::TYPE_INTEGER . '(11) NOT NULL DEFAULT 0',
                'apply_time'  => Schema::TYPE_INTEGER . '(11) NOT NULL DEFAULT 0',
                'auditor'     => Schema::TYPE_INTEGER . '(11) NOT NULL DEFAULT 0',
                'audit_time'  => Schema::TYPE_INTEGER . '(11) NOT NULL DEFAULT 0',
